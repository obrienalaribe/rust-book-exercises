...
//!
//! If, after taking this exam, you find that you are not adequately experienced in Rust to attend
//! the Academy, we encourage you to continue studying Rust, and apply again for a future cohort of
//! the Academy!

/// You must keep the entirety of this exam. This includes the test's questions and source, and your
...
/// The coding portion of the exam allows access to books, and websites such as the Rust book, the
/// standard library reference, and others. However, you not allowed to use external dependencies
...
/// The coding portion of the exam allows access to books, and websites such as the Rust book, the
/// standard library reference, and others.
/// However, you are not allowed to use AI assisted coding tools like Github Copilot to complete
/// this exam.
